...
IMPORTANT: Before interacting with any dataset, your FIRST step MUST ALWAYS be to understand its structure using the get_metadata function. Only when this step is done you can proceed to read the dataset.
    ...
    def go(self, prompt):
        ...
        print("\n" + "="*50)
        print("AGENT RUN COMPLETE. INITIATING APKA AUDIT.")
        print("="*50 + "\n")
        ...
        # 3. Run the analysis on the complete transcript.
        analysis_results = apak_auditor.analyze_transcript(full_transcript)

        # 4. (Optional) Pretty-print the analysis results to the console.
        print("--- APKA ANALYSIS RESULTS ---")
        print(json.dumps(analysis_results, indent=2))
        print("--- END OF APKA ANALYSIS ---\n")

        return self.log, message.content, analysis_results
